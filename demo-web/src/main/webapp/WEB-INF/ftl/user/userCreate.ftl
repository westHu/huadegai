...
<@header title="新增用户" css_war = "treeview,icheck,gritter_css"></@header>
<body class="sticky-header">
<section>
    <@left title="导航栏"></@left>
    <div class="main-content" >
        <@notification title="通知"></@notification>
        <@pageHeading title_1="新增用户"  title_3="系统设置" title_4="用户管理" title_4_url="${context.contextPath}/user/list"></@pageHeading>
        <hr/>
        <div class="wrapper">
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="widget-block">
                                <div class="widget-content box-padding">
                                    <form id="stepy_form" class=" form-horizontal left-align form-well"
                                          <#if op == '新增'>action="${context.contextPath}/user/create"<#elseif op == '更新'>action="${context.contextPath}/user/update"</#if>  method="post">
                                        <fieldset title="登录信息">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    ...
                                                    <input  class="form-control" name="username" placeholder="登录名,用于登录 "  value="${user.username}" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" name="email" type="email" placeholder="邮箱，唯一可登录" value="${user.email}" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input  class="form-control" name="mobile" data-mask="199-9999-9999" placeholder="手机号码，唯一可登录" value="${user.mobile}" required/>
                                                </div>
                                            </div>
                                        </fieldset>
                                        <fieldset title="联系信息">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input  class="form-control" name="realName" placeholder="真实姓名，用于显示" value="${user.realName}" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" name="identityCardNo" data-mask="999999 99999999 9999" placeholder="用于身份核实" value="330825192373820283" readonly/>
                                                </div>
                                            </div>
                                        ...
                                        <fieldset title="组织权限信息">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input id="organization"  class="form-control" value="${user.organizationName}" onclick="$('#treeView-panel').show()" autocomplete="off" required>
                                        ...
                                        <div class="btn col-lg-10">
                                            <#if op == '新增'>
                                                <button class="btn btn-primary btn-extend" type="submit">新&nbsp增用户</button>
                                                <button class="btn btn-default btn-extend" type="reset"> 重&nbsp置表单</button>
                                            <#elseif op == '更新'>
                                                <button class="btn btn-primary btn-extend" type="submit">更&nbsp新用户</button>
                                            </#if>
...
<@js_lib js_war="treeview,input_mask,icheck,gritter_script"></@js_lib>
<script>
