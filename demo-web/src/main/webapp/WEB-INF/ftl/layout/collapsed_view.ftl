...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <!--sidebar nav start-->
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li><a href="${context.contextPath}/home"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                <li class="menu-list nav-active"><a href=""><i class="fa fa-laptop"></i> <span>Layouts</span></a>
                    <ul class="sub-menu-list">
                        <li ><a href="${context.contextPath}/home"> 正常布局</a></li>
                        <li><a href="${context.contextPath}/layout/boxed"> 魔盒布局</a></li>
                        <li class="active"><a href="#"> 折叠布局</a></li>
