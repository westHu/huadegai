...
<@header title="设备报废" css_war="responsive_table,gritter_css,pickers_css,paging-hup_css">
</@header>
...
<section>
    ...
    <div class="main-content" >
        ...
        <@pageHeading title_1="报废列表"  title_3="设备管理" title_4="设备报废" title_4_url="#"></@pageHeading>
        <div class="wrapper">
            <div class="row">
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <div class="btn-group">
                                <button class="btn btn-primary" type="button">新增报废</button>
                                <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button">
                                    <span class="caret"></span>
                                    <span class="sr-only">Toggle Dropdown</span>
                                </button>
                                <ul role="menu" class="dropdown-menu">
                                    <li><a href="${context.contextPath}/device/scrap/create">新增报废单</a></li>
                                    <li><a href="#">导入设备</a></li>
                                    ...
                                    <tbody>
                                        <#list page.getList() as obj>
                                            <tr>
                                                ...
                                                <td>${obj.scrapDate?string("yyyy-MM-dd")}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul role="menu" class="dropdown-menu">
                                                            <li><a href="${context.contextPath}/device/scrap/${obj.id}/view" >查看报废单</a></li>
                                                            <li><a href="${context.contextPath}/device/scrap/${obj.id}/update?currentPage=${page.currentPage}&pageSize=${page.pageSize}" >编辑入库单</a></li>
                                                            <li><a href="#deleteDevicescrap" data-toggle="modal" onclick="delete_device_scrap(${obj.id},this)" >删除入库单</a></li>
                                                            <li class="divider"></li>
...
<script>
    ...
    function delete_device_scrap(id, inputObj) {
        $('#deleteId').val(id);
        //如果后台成功则调用下列参数进行页面删除
    ...
    function confirmDeleteRepair() {
        ...
        var url =  "/device/scrap/"+id+"/delete";
        $.ajax({
            url: url,
            type: 'post',
...
<script>
    ...
    $("#page").paging({
        ...
        callback: function(num) {
            ...
            var pageUrl =  "${context.contextPath}/device/scrap?currentPage="+num+"&pageSize="+pageSize;
